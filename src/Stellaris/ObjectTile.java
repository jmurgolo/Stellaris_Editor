...
public class ObjectTile {
    ...
    public void setglobaltileidtotal(String s) {
        globaltileidtotal.set(s);
    }

    public StringProperty globaltileidtotalProperty() {
        return globaltileidtotal;
    }
    ...
    public void setblocker(String s) {
        blocker.set(s);
    }

    public StringProperty blockerProperty() {
        return blocker;
    }
    ...
    public StringProperty depositProperty() {
        return deposit;
    }
    ...
    public void setprevbuilding(String s) {
        prevbuilding.set(s);
    }

    public StringProperty prevbuildingProperty() {
        return prevbuilding;
    }

    public void setresourcequantity(String s, int index) {
        resourcequantity[index].set(s);
    }

    public StringProperty[] resourcequantityProperty() {
